...
<body>
	...
	<div id="content-box">
			<div id="element-box" class="login">
				<div class="wbg">
					<h1><?php echo "Photo Check-in Login System"; ?></h1>
					<jdoc:include type="message" />
					<jdoc:include type="component" />
					<div class="ajaxload">
							<p>This Project Photo Check-in Develop by Team Students Project
							   
							</p>
						
					</div>
					<p><a href="<?php echo JURI::root(); ?>">Go to View Site >> </a></p>
					<div id="lock"></div>
				</div>
			</div>
			<noscript>
